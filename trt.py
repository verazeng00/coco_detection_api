...
if __name__ == '__main__':
    ...
    if img_path:
      ...
      pred_img = pred.inference(origin_img, conf=0.1, end2end=args.end2end)
      print(pred_img.shape)
      cv2.imwrite("%s" %args.output , pred_img)
    if video:
      pred.detect_video(video, conf=0.1, end2end=args.end2end) # set 0 use a webcam


# python3 trt.py \
# --engine models/coco/yolov7-tiny.trt \
# --image sample_dataset/bus.jpg \
# --output sample_dataset/bus_out.jpg \
# --end2end 